...
function validateName (fieldName) {
    ...
    if (firstname.length < 1) {
        document.getElementById(valildator).innerHTML = '<p class="error-message">This field is required!</p>';
...
function validateUserID () {
    ...
    if (userID.length < 1) {
        document.getElementById("userIDValidator").innerHTML = '<p class="error-message">This field is required!</p>';
        document.getElementById("userID").style.backgroundColor = "#ffc8c8"
        return false;
    } else {
        
        if (checkNumeric(userID[0])) {
            document.getElementById("userIDValidator").innerHTML = '<p class="error-message">The first character can not be a number!</p>';
            document.getElementById("userID").style.backgroundColor = "#ffc8c8"
            return false;
        } else if (userID.includes(" ")) {
            document.getElementById("userIDValidator").innerHTML = '<p class="error-message">User ID can not include spaces!</p>';
            document.getElementById("userID").style.backgroundColor = "#ffc8c8"
            return false;
        } else if (specialCharTest.test(userID)) {
            document.getElementById("userIDValidator").innerHTML = '<p class="error-message">Only dashes and underscores can be used!</p>';
            document.getElementById("userID").style.backgroundColor = "#ffc8c8"
            return false;
        }  else {
...
function validateDate () {
    ...
    if (today.getFullYear() - selectedDate.getFullYear() > 120) {
        document.getElementById("birthDateValidator").innerHTML = '<p class="error-message">Your birthday can not be past 120 years!</p>';
        document.getElementById("birthDate").style.backgroundColor = "#ffc8c8"
        return false;
    } else if (selectedDate > today) {
        document.getElementById("birthDateValidator").innerHTML = '<p class="error-message">You can not select a date in the future!</p>';
        document.getElementById("birthDate").style.backgroundColor = "#ffc8c8"
        return false;
    } else {
...
function validatePassword () {
    ...
    if (password.length < 1) {
        document.getElementById("passwordValidator").innerHTML = '<p class="error-message">This field is required!</p>';
        document.getElementById("password").style.backgroundColor = "#ffc8c8"
        return false;
    }
     else if (!uppercaseCheck.test(password)) {
        document.getElementById("passwordValidator").innerHTML = '<p class="error-message">Your password requires an uppercase letter!</p>';
        document.getElementById("password").style.backgroundColor = "#ffc8c8"
        return false;
    }
     else if (!numberCheck.test(password)) {
        document.getElementById("passwordValidator").innerHTML = '<p class="error-message">Your password requires a number!</p>';
        document.getElementById("password").style.backgroundColor = "#ffc8c8"
        return false;
    } else if (!specialCheck.test(password)) {
        document.getElementById("passwordValidator").innerHTML = '<p class="error-message">Your password requires a special character!</p>';
        document.getElementById("password").style.backgroundColor = "#ffc8c8"
        return false;
    } else if (password == userID) {
        document.getElementById("passwordValidator").innerHTML = '<p class="error-message">Your password can not be the same as your User ID!</p>';
        document.getElementById("password").style.backgroundColor = "#ffc8c8"
        return false;
    } else if (password.includes(firstName)) {
        document.getElementById("passwordValidator").innerHTML = '<p class="error-message">Your password can not contain your name!</p>';
        document.getElementById("password").style.backgroundColor = "#ffc8c8"
        return false;
    } else {
...
function validateConfirmPassword () {
    ...
    if (confirmPassword.length < 1 ) {
        document.getElementById("confirmPasswordValidator").innerHTML = '<p class="error-message">This field is required!</p>';
        document.getElementById("confirmPassword").style.backgroundColor = "#ffc8c8"
        return false;
    } else if (password != confirmPassword) {
        document.getElementById("confirmPasswordValidator").innerHTML = '<p class="error-message">This your passwords must match!</p>';
        document.getElementById("confirmPassword").style.backgroundColor = "#ffc8c8"
        return false;
    } else {
...
function validateState () {
    ...
    if (state.length < 1 ) {
        document.getElementById("stateValidator").innerHTML = '<p class="error-message">This field is required!</p>';
...
function validateCity () {
    ...
    if (city.length < 1 ) {
        document.getElementById("cityValidator").innerHTML = '<p class="error-message">This field is required!</p>';
...
function validateZip () {
    ...
    if (zipCode.length < 1 ) {
        document.getElementById("zipCodeValidator").innerHTML = '<p class="error-message">This field is required!</p>';
